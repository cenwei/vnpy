...
class DbTickData(Document):
    ...
    bid_price_6: float = FloatField()
    bid_price_7: float = FloatField()
    bid_price_8: float = FloatField()
    bid_price_9: float = FloatField()
    bid_price_10: float = FloatField()
    bid_price_11: float = FloatField()
    bid_price_12: float = FloatField()
    bid_price_13: float = FloatField()
    bid_price_14: float = FloatField()
    bid_price_15: float = FloatField()
    bid_price_16: float = FloatField()
    bid_price_17: float = FloatField()
    bid_price_18: float = FloatField()
    bid_price_19: float = FloatField()
    bid_price_20: float = FloatField()
    ...
    ask_price_6: float = FloatField()
    ask_price_7: float = FloatField()
    ask_price_8: float = FloatField()
    ask_price_9: float = FloatField()
    ask_price_10: float = FloatField()
    ask_price_11: float = FloatField()
    ask_price_12: float = FloatField()
    ask_price_13: float = FloatField()
    ask_price_14: float = FloatField()
    ask_price_15: float = FloatField()
    ask_price_16: float = FloatField()
    ask_price_17: float = FloatField()
    ask_price_18: float = FloatField()
    ask_price_19: float = FloatField()
    ask_price_20: float = FloatField()
    ...
    bid_volume_6: float = FloatField()
    bid_volume_7: float = FloatField()
    bid_volume_8: float = FloatField()
    bid_volume_9: float = FloatField()
    bid_volume_10: float = FloatField()
    bid_volume_11: float = FloatField()
    bid_volume_12: float = FloatField()
    bid_volume_13: float = FloatField()
    bid_volume_14: float = FloatField()
    bid_volume_15: float = FloatField()
    bid_volume_16: float = FloatField()
    bid_volume_17: float = FloatField()
    bid_volume_18: float = FloatField()
    bid_volume_19: float = FloatField()
    bid_volume_20: float = FloatField()
    ...
    ask_volume_6: float = FloatField()
    ask_volume_7: float = FloatField()
    ask_volume_8: float = FloatField()
    ask_volume_9: float = FloatField()
    ask_volume_10: float = FloatField()
    ask_volume_11: float = FloatField()
    ask_volume_12: float = FloatField()
    ask_volume_13: float = FloatField()
    ask_volume_14: float = FloatField()
    ask_volume_15: float = FloatField()
    ask_volume_16: float = FloatField()
    ask_volume_17: float = FloatField()
    ask_volume_18: float = FloatField()
    ask_volume_19: float = FloatField()
    ask_volume_20: float = FloatField()
